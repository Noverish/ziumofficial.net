<?php
    ...
    ($user_token = $_POST["user_token"]) != NULL or $user_token = $user_id;
    ...
    $sql_review =
        ...
        "(SELECT COUNT(_id) FROM UserLikes WHERE UserLikes.user_id = $user_token && UserLikes.review_id = Review._id) as is_user_liked ".
        "FROM UserLikes ".
